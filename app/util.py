...
def clone_repo_with_pr(src_dir, repo, remote_url, pr_num, depth, pr_type = "head"):
    '''
    ...
    subprocess.getoutput(f'git fetch origin +refs/merge-requests/{pr_num}/{pr_type}:pr_{pr_num} --depth={depth}')
